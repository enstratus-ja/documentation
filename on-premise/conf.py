...
extensions = ['sphinx.ext.intersphinx', 'sphinxjp.themecore']
...
# documentation.
#html_theme_options = {}
html_theme_options = {'maincolor': '#36636B'}
...
latex_documents = [
  ('index', 'enStratus-On-Premise.tex', u'enStratus On-Premise Documentation',
...
man_pages = [
    ('index', 'enstratus', u'enStratus On-Premise Documentation',
     [u'enStratus'], 1)
]
